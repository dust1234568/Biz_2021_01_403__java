...
public class Class_05 {
	...
	public static void main(String[] args) {
		 ...
		 * 출력한 후 자동 줄바꿈을 하여 이후 출력되는 결과가 다음줄에 출력되도록 하는 기능
		 * ()안에 아무것도 없으면 빈줄만 출력
		 */
		System.out.println();
		 ...
		 * 단, 출력후 줄바꿈을 하지않아 이후 출력되는 결과가 이어서(옆으로) 출력
		 * 또한, ()안의 내용을 생략 할 수 없다
		 */
		...
		System.out.printf("숫자 : %15d\n", 3); // %5 : 다섯칸(자릿수)을 만들고 오른쪽부터 입력해라
		System.out.printf("숫자 : %15d\n", 300);
		System.out.printf("숫자 : %15d\n", 3000);
		System.out.printf("숫자 : %15d\n", 30000);
		System.out.println("==================================");
		
		// 일단 15개짜리 빈 공간을 만들고 숫자를 오른쪽 정렬 왼쪽의 빈칸을 문자열 "0"으로 채우기
		System.out.printf("숫자 : %015d\n", 3); // %0 : 빈 칸은 0 으로 채워라
		System.out.printf("숫자 : %015d\n", 300);
		System.out.printf("숫자 : %015d\n", 3000);
		System.out.printf("숫자 : %015d\n", 30000);
		System.out.println("==================================");
		// 일단 15개짜리 빈 공간을 만들고 숫자를 왼쪽 정렬
		System.out.printf("숫자 : %-15d\n", 3); // %0 : 빈 칸은 0 으로 채워라
		System.out.printf("숫자 : %-15d\n", 300);
		System.out.printf("숫자 : %-15d\n", 3000);
		System.out.printf("숫자 : %-15d\n", 30000);
		...
		// %d일 경우 값보다 자릿수가 부족할 경우 형식이 어긋난다
		...
		// 실수표현 : %f
		// 정수부분 3자리, 소수점부분 2자리(3번째에서 반올림)
		System.out.printf("%3.2f\n", 30.6666); // 정수3자리, 실수2자리 표현
