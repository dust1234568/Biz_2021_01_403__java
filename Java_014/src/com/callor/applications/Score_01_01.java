...
public class Score_01_01 {
	...
	public static void main(String[] args) {
		...
		/*
		 * 변수는 1개의 변수에 1개의 값만 저장할 수 있다 => 3명 학생의 과목점수를 저장해야 하기 떄문에 각 과목을 배열로 선언 => 몇개의
		 * 배열이 필요한지 명시(알려주기) = new int[개수]
		 * 
		 */
		...
		// 학생 인원수가 몇명 안될때는 아래처럼 단순히 복사 붙히기로 코드를 작성해도 된다
		...
		// for() 반복문을 이용하여 반복되는 (복사&붙히기) 코드를 단순하게 만든다
