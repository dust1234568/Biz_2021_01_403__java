...
public class ScoreServiceV1 {
	...
	public void init() {
		...
		// scanner 와 Random을 선언하는것과 분리하여 생성하는 코드를 작성했다
		scan = new Scanner(System.in);
		rnd = new Random();

		System.out.println("몇명의 학생 성적을 처리 하려고 하나요 ");
		System.out.print("학생수 >> ");
		String strNums = scan.nextLine();
		int intNums = Integer.valueOf(strNums);

		// 입력 받은 학생 수 만큼 성적입력 배열 생성
	...
	public void makeNamesAndArratInit() {
