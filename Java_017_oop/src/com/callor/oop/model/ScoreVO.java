...
/*
 * Value Object 의 인스턴스 변수 은닉
 * 인스턴스 변수는 public으로 선언하지 않고
 * 보통 private으로 선언을 한다
 * 
 * VO클래스를 사용하여 선언된 vo 객체는 인스턴스 변수에 직접 접근할 수 없다
 * 	ScoreVO sVO = new ScoreVO();
 * 	sVO.strName = "홍길동" // 이런코드는 사용불가
 * 	String name = sVO.strName; // 이 코드도 사용불가
 * 
 * private으로 선언된 인스턴스에 접근하기 위한 setter, getter method 이라 하고
 * 이 method 들을 통해서 접근해야한다
