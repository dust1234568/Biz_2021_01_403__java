...
public class List_02 {
	...
	public static void main(String[] args) {
		...
		/*
		 * 배열은 처음 생성할때 지정한 type 이외에는 어떠한 type도 저장 할 수 없다
		 * 
		 * 이미 선언된 배열을 다른 type으로 다시 선언 할 수도 없다
		 * 
		 */
		int[] nums = new int[10];
		// nums[0] = 30;
		// nums[1] = "30"; // 문법오류 숫자형에 문자열입력
		// nums[2] = "대한민국";
		
		// nums = new float[10];
		// nums[3] = 30f; // 문법오류 숫자형에 실수형 입력
		...
		// <String> : Generic type
		// 	strList1은 ArrayList 객체이지만 여기에는 문자열만 저장하도록 하겠다
		// 	Generic type은 int, float, long, double 등은 사용불가
		// 	Generic type은 Integer, Flaot, Long, Double, String 등을 사용해야 한다
