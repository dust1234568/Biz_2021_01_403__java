...
public class FIleWriter_04 {
	 ...
	 * 
	 * static 변수는 GC (Garbage Collection) 이 접근하지 못한다
	 * 프로젝트가 시작될때 만들어 지고, 계속 존재하는 상태
	 ...
	 */
	private static String numsFile = "src/com/callor/shop/files/nums_01.txt";
	private static List<Integer> intList;
	
	static {
		numsFile = "src/com/callor/shop/files/nums_01.txt";
		intList = new ArrayList<Integer>();
	}

	/*
	 * main() method와 같은 클래스내에 있는 다른 method를 호출하여 코드를 수행 할 경우
	...
	public static void main(String[] args) {
		...
		/*
		 * 1. static 으로 선언된 method 내에서는 같은 클래스의 다른 method 를
