 ...
 * 
 * Java class
 * - java 언어 문법에 맞도곩 작성된 문서 파일
 * - public class 키워드로 시작을 하고
 * - 임의로 이름을 작성하여 만든다.
 * 		여기에서는) Hello
 * - Hello.java 라는 파일에 코드가 저장된다
 * - 클래스 이름과 파일 이름은 항상 같아야 한다
 * - 클래스가 HelloKorea이면
 * 		파일 이름은 HelloKorea.java로 작성을 한다
...
public class HelloKorea {
	...
	/*
	 * main() method 라고 부른다 클래스를 만들고 컴파일을 수행한 후 실행을 했을 때 반드시 있어야 하는 명령문
	...
	public static void main(String args[]) {
		//Console 출력(명령)문
		System.out.println("30 + 40 = " + (30 + 40)); // 코드를 자동으로 문자열로 바꿈 / 자동형 변환
		System.out.println("30 x 40 = " + 30 * 40); // 자동형 변환
		System.out.println("40 - 30 = " + (40 - 30)); // 오류 자동으로 바꾸지 않음 / 강제형 변환
		 ...
		 * 					문자열 산술식은 + 연산만 가능
		 * 3. 문자열 + 숫자 산술식 : 모든 숫자를 자동으로 문자열화 하여 문자열 산술식으로 바꾸어 연산하고 결과를 출력 
		 * 
		 *  
		 */
	}
